...
test "$TESTNAME: display program help"
    (fishtape | xargs) = "usage: fishtape [<file> [...]] [--dry-run] [--pipe=<utility>] [--quiet] [--help] [--version] --pipe=<utility> Pipe line buffered output into <utility> -d --dry-run Print preprocessed files to stdout -q --quiet Set quiet mode -v --version Show version information -h --help Show help"
end
